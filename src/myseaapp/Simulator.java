...
public class Simulator {
    ...
    public  ArrayList<String> instrucitons;
    ...
    private ArrayList<String> textLog; //what happened in whatever clock step.  mm 
